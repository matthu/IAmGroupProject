...
import Step12 from '../images/steps1,2.png';
...
function About() {
  ...
  return (
    <div className={classes.root}>
      <br />
      <Typography variant='h4' style={{ fontSize: "1.8rem", color: "green" }}>Introduction / Problem Background / Motivation</Typography>
      <br />
      ...
      <br />
      <br />
      <Typography variant='h4' style={{ fontSize: "1.8rem", color: "green" }}>Proposed Solution / Methods Used</Typography>
      <br />
      ...
      <br />
      <img className={classes.steps12} src={Step12} alt="Steps 1 and 2"/>
      <br />
      <br />
      <Typography>The above diagram shows the first two steps in the calculations. In <b>Step 1</b>, all tokens of each user pair are scored by adding the max cosine similarity with the other user's terms, the max cosine similarity with the focus category terms, the concreteness of the term, and the TF-IDF value of the term. Each value is individually weighted. Then in <b>Step 2</b>, the highest top-k user pair term scores are averaged to create the final user pair similarity score.</Typography>
      <br />
      <img className={classes.step3} src={Step3} alt="Step 3"/>
      <br />
      <br />
      <Typography>Finally in <b>Step 3</b>, the final user pair similarity scores are ordered by highest similarity and groups of four are made from the most similar users. This is how we recommended the highest similarity groups.</Typography>
      <br />
      <br />
      <Typography variant='h4' style={{ fontSize: "1.8rem", color: "green" }}>Evaluation and Analysis of Results</Typography>
      <br />
      ...
      <br />
      <br />
      <Typography variant='h4' style={{ fontSize: "1.8rem", color: "green" }}>Conclusion</Typography>
      <br />
